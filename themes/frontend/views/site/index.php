...
.nav-collapse .nav li{
	...
	<div class="span12">
		<div class="isotope is-varying-sizes rainbowed" id="container">
			<div class="element-item span6 height4" style="margin-left: 2.564102564102564%;"><p class="symbol">1</p>
				<?php 
					$this->widget(
			...
			<div class="element-item span6 svgcolor ">
				<p class="symbol">2</p>
				<div class="span3">
        ...
        ?>
			...
			<div class="element-item span6 height2"><p class="symbol">4</p>
				<?php 
					$this->widget(
			...
			<div class="element-item span6  height2"><p class="symbol">5</p>
				<?php 
					$this->widget(
			...
			<div class="element-item span6 height2" style="margin-left: 2.564102564102564%;"><p class="symbol">12</p></div>
		</div>
	</div>
<script>
	$(document).ready(function(){
