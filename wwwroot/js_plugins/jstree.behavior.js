...
$(function () {
    ...
    $("#" + JsTreeBehavior.container_ID)
        .jstree({
            ...
            "html_data":{
                "ajax":{
                    ...
                    "url": "/" + Yii_js.module + "/" + JsTreeBehavior.controllerID + "/fetchTree",
                    "data":function (n) {
                        return {
            ...
            "contextmenu":{ 'items':{
                ...
                "update":{
                    ...
                    "action":function (obj) {
                        ...
                        $.ajax({
                            type:"POST",
                            url:"/" + Yii_js.module + "/" + JsTreeBehavior.controllerID + "/returnForm",
                            data:{
                                'update_id':id,
                                "YII_CSRF_TOKEN":Yii_js.csrf
                            },
                ...
                "properties":{
                    ...
                    "action":function (obj) {
                        ...
                        $.ajax({
                            type:"POST",
                            url:"/" + Yii_js.module + "/" + JsTreeBehavior.controllerID + "/returnView",
                            data:{
                                "id":id,
                                "YII_CSRF_TOKEN":Yii_js.csrf
                            },
        ...
        .bind("rename.jstree", function (e, data) {
            $.ajax({
                type:"POST",
                url:"/" + Yii_js.module + "/" +  JsTreeBehavior.controllerID + "/rename",
                data:{
        ...
        .bind("remove.jstree", function (e, data) {
            $.ajax({
                type:"POST",
                url:"/" + Yii_js.module + "/" +  JsTreeBehavior.controllerID + "/remove",
                data:{
                    "id":data.rslt.obj.attr("id").replace("node_", ""),
                    "YII_CSRF_TOKEN":Yii_js.csrf
                },
...
//                      console.log(replaced_node,'REPLACED NODE');
                ...
                $.ajax({
                    ...
                    url:"/" +  Yii_js.module + "/" +JsTreeBehavior.controllerID + "/moveCopy",
